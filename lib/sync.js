...
(function() {
  var async, crypto, cstep, fs, hash, mime, mkdirp, outcome, path, rmdir, sift, step, walkr, winston;
  ...
  module.exports = (function() {
    ...
    */
    ...
    function _Class(s3cp, options) {
      ...
      this._basePath = fs.realpathSync(this.options.path);
      this._s3 = s3cp._s3;
    }
    ...
    */
    ...
    _Class.prototype.start = cstep(function(callback) {
      var o, self;
    ...
    */
    ...
    _Class.prototype.upload = cstep(function(callback) {
      var o, self;
      self = this;
    ...
    */
    ...
    _Class.prototype.redownload = cstep(function(callback) {
      var _this = this;
      if (fs.existsSync(this.options.path)) {
        return rmdir(this.options.path, function() {
          return _this._download(callback);
        });
      } else {
        return this._download(callback);
      }
    });
    ...
    */
    ...
    _Class.prototype.download = cstep(function(callback) {
      return this._download(callback);
    });

    _Class.prototype._download = function(callback) {
      var o, self;
      o = outcome.e(function(err) {
        return callback();
      });
    ...
    */
    ...
    _Class.prototype._uploadFiles = function(callback) {
      var _this = this;
      return async.eachLimit(this._localManifestDiff, 20, (function(file, next) {
        var retry, tries;
        if (file.dir) {
          return next();
        }
    ...
    */
    ...
    _Class.prototype._scanLocalFiles = function(callback) {
      ...
      return walkr(this.options.path).filter(function(file, next) {
        file.destination = file.source.replace(_this._basePath, "");
