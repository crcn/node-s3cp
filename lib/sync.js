    ...
    */
    ...
    _Class.prototype._uploadFile = function(file, next) {
      ...
      tryUploadingFile = function() {
        ...
        return _this._s3.putFile(file.lpath, file.rpath.replace(/\s/g, "%20"), function(err) {
          if (err) {
      ...
      return this._shouldReUploadFile(file, outcome.e(next).s(function(shouldReUpload) {
        if (!shouldReUpload) {
